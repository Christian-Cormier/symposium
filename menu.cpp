//********************************************************************
//Name: Christian Cormier
//First Year Symposium
//Date: 11/18/2021
//Program description: This program creates a simple text based game based on a freshmans decision within their first year of college
//*********************************************************************
...
//rt1()
//this function creates the top half of the splash screen
void rt1()
{
    int x,  y;
    for(x = 1; x <= 10; x++)
...
//rt2()
//this function creates the bottom half of the splashscreen
void rt2(){
    int x, y;
    for (x = 10; x >= 1; x--){
        for(y = 1; y <= 10; y++){
...
//splashScreen()
//this function creates the actual splashscreen using strings
void splashScreen(){
    string str;
    rt1();
...
//day()
// int &a - counter
// this function counts the days for every day the player progresses
void day(int &a)
{
    a+=1;
...
// string name - the name of the player submitting their score
// this function takes the players score and name and appends it to a file in order to save their score
...
//scoreboard()
// this function outputs every score on the scoreboard
void scoreboard(){
    ifstream inFile;
    inFile.open("scoreboard.txt");
    string scores;
